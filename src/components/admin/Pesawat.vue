  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <p class="card-title float-left"><b>JADWAL PESAWAT</b></p>
  ...
  methods: {
    ...
    Save: function () {
      ...
      if (this.action === "insert") {
        ...
        this.axios
          .put("/plane/" + this.id_transportation, form, conf)
          .then((response) => {
            this.$bvToast.hide("loadingToast");
            if (this.search == "") {
              this.getData();
    ...
    Drop: function (id_transportation) {
      ...
      if (confirm("Apakah anda yakin ingin menghapus data ini?")) {
        this.$bvToast.show("loadingToast");
        this.axios
          .delete("/plane/" + id_transportation, conf)
          .then((response) => {
            this.getData();
            this.$bvToast.hide("loadingToast");
            this.message = response.data.message;
